...
// It is constructed of a token, a function and a slice of
// expressions for the function arguments
type CallExpression struct {
	Token     token.Token // The "(" token
	Function  Expression  // Identifer _or_ FunctionLiteral
	Arguments []Expression
}

func (ce *CallExpression) expressionNode() {}

// TokenLiteral returns the token literal for the call expression
